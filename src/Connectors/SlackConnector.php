...
class SlackConnector extends Connector implements ConnectorInterface
{
    ...
    public function send($message)
    {
        ...
        if ($message->getAuthor() !== null) {
            $this->setAuthor(
                ...
                app('flarum.config')['url']."/u/{$message->getAuthor()->id}",
                $message->getAuthor()->avatar_url
            );
    ...
    /**
     * Sets the message on the Slack attachment.
     * Also sets the fallback which is going to be displayed in system notifications.
     * 
